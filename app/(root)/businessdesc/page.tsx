...
export default function BusinessDescriptionPage() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      router.push('/businessaudience'); // Assuming next page is businessaudience
    } catch (err) {
  ...
  return (
    ...
    <div className="w-full max-w-3xl mx-auto bg-gray-950/30 border border-green-800/30 rounded-2xl p-8 shadow-2xl shadow-green-950/20">
      ...
      <div className="flex flex-col items-center">
        <p className="text-sm font-semibold text-green-400 uppercase tracking-wider">Step 3 of 6</p>
      ...
      <p className="mt-3 text-lg text-gray-400 text-center max-w-xl mx-auto">
        What do you do? Who are your customers? The more detail you provide, the better our AI can analyze your idea.
      </p>

      {/* A more visually appealing textarea input */}
      <div className="mt-10 w-full">
        <textarea
          ...
          className="w-full h-48 bg-[#14532d]/40 backdrop-blur-sm rounded-xl p-4 text-white text-lg placeholder-gray-400/70 outline-none border-2 border-transparent focus:border-green-500 focus:ring-2 focus:ring-green-500/50 transition-all duration-300 resize-none"
          autoFocus
        />
      </div>
