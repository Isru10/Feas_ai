...
export default function BusinessNamePage() {
  ...
  return (
    // We use a container with a subtle background and border to create a "card" effect.
    <div className="w-full max-w-2xl mx-auto bg-gray-950/30 border border-green-800/30 rounded-2xl p-8 shadow-2xl shadow-green-950/20">
      ...
      <div className="flex flex-col items-center">
        <p className="text-sm font-semibold text-green-400 uppercase tracking-wider">Step 1 of 6</p>
      ...
      <h1 className="text-4xl sm:text-5xl font-bold text-gray-100 leading-tight text-center mt-8">
        Alright, let as start with the name of
        <br />
        your business.
      </h1>
      ...
      <div className="mt-10 w-full">
        <div className="relative">
          <input
            ...
            placeholder="e.g., QuantumLeap Coffee"
